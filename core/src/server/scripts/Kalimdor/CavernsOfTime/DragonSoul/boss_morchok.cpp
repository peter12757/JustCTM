    ...
    struct boss_ds_morchokAI : public BossAI
    {
        ...
        void Reset() override
        {
            ...
            else if (instance->GetData(DATA_RAID_NERF) == RAID_NERF_ACTIVE && !me->HasAura(SPELL_PRESENCE_OF_THE_DRAGON_SOUL))
            {
                ...
                me->CastSpell(me, SPELL_PRESENCE_OF_THE_DRAGON_SOUL, CastSpellExtraArgs(true).AddSpellBP0(currentNormalAndHcNerfAmount).AddSpellBP1(currentNormalAndHcNerfAmount));
            ...
            if (IsHeroic())
            {
                if (Creature* kohcrom = me->FindNearestCreature(NPC_KOHCROM, 500.00f))
                {
                    ...
                    else
                    {
                        ...
                        {
                            damage /= 2;
                            me->DealDamage(attacker, kohcrom, damage);
                        }
                    }
                }
            }
            ...
            while (uint32 eventid = events.ExecuteEvent())
            {
                switch (eventid)
                {
                    ...
                    case EVENT_RESONATING_CRYSTAL:
                    {
                        ...
                        me->CastSpell(CastSpellTargetArg(pos),
                                      SPELL_RESONATING_CRYSTAL_SUMMON, true);
                    ...
                    case EVENT_REACT_AGGRESSIVE:
                        me->SetReactState(REACT_AGGRESSIVE);
                        me->SetInCombatWith(me->SelectVictim());
                        break;
                    default:
                        break;
                }
            ...
            if (IsHeroic())
            {
                if (Creature* morchok = instance->GetCreature(DATA_MORCHOK))
                {
                    ...
                    else
                    {
                        ...
                        {
                            damage /= 2;
                            me->DealDamage(attacker, morchok, damage);
                        }
                    }
                }
            }
...
public:
    ...
    class spell_ds_target_selection_SpellScript : public SpellScript
    {
        ...
        void Register()
        {
            OnObjectAreaTargetSelect.Register(&spell_ds_target_selection_SpellScript::FilterTargets, EFFECT_1,
                                              TARGET_UNIT_DEST_AREA_ENEMY);
            OnEffectHitTarget.Register(&spell_ds_target_selection_SpellScript::HandleDummy, EFFECT_1,
                                       SPELL_EFFECT_DUMMY);
            OnHit.Register(&spell_ds_target_selection_SpellScript::RemoveAuras);
        }
    };
...
public:
    ...
    class spell_ds_resonating_crystal_periodic_AuraScript : public AuraScript
    {
        ...
        void Register()
        {
            OnEffectPeriodic.Register(&spell_ds_resonating_crystal_periodic_AuraScript::HandleTriggerSpell, EFFECT_0,
...
public:
    ...
    class spell_ds_resonating_crystal_explosion_SpellScript : public SpellScript
    {
        ...
        void Register()
        {
            OnObjectAreaTargetSelect.Register(&spell_ds_resonating_crystal_explosion_SpellScript::FilterTargets,
                                              EFFECT_0, TARGET_UNIT_DEST_AREA_ENEMY);
            OnObjectAreaTargetSelect.Register(&spell_ds_resonating_crystal_explosion_SpellScript::FilterTargetsShared,
                                              EFFECT_1, TARGET_UNIT_DEST_AREA_ENEMY);
            OnObjectAreaTargetSelect.Register(&spell_ds_resonating_crystal_explosion_SpellScript::FilterTargetsShared,
                                              EFFECT_2, TARGET_UNIT_DEST_AREA_ENEMY);
            OnEffectLaunch.Register(&spell_ds_resonating_crystal_explosion_SpellScript::CountBuffs, EFFECT_0,
                                    SPELL_EFFECT_SCHOOL_DAMAGE);
            OnEffectHitTarget.Register(&spell_ds_resonating_crystal_explosion_SpellScript::HandleDamage, EFFECT_0,
                                       SPELL_EFFECT_SCHOOL_DAMAGE);
        }
    };
    ...
    class spell_ds_falling_fragments_periodic_AuraScript : public AuraScript
    {
        ...
        void HandleTriggerSpell(AuraEffect const* aurEff)
        {
            ...
            while (maxAttemps < 20)
            {
                ...
                if (!nearObject)
                {
                    GetCaster()->CastSpell(CastSpellTargetArg(pos), SPELL_FALLING_FRAGMENT_MISSILE, true);
                    break;
                }
                maxAttemps++;
            }
        ...
        void Register()
        {
            OnEffectPeriodic.Register(&spell_ds_falling_fragments_periodic_AuraScript::HandleTriggerSpell, EFFECT_0,
                                      SPELL_AURA_PERIODIC_TRIGGER_SPELL);
        }
    };
...
public:
    ...
    class spell_ds_earthen_vortex_teleport_SpellScript : public SpellScript
    {
        ...
        void Register()
        {
            OnObjectAreaTargetSelect.Register(&spell_ds_earthen_vortex_teleport_SpellScript::FilterEffect0, EFFECT_0,
                                              TARGET_UNIT_DEST_AREA_ENEMY);
            OnObjectAreaTargetSelect.Register(&spell_ds_earthen_vortex_teleport_SpellScript::FilterEffect1, EFFECT_1,
                                              TARGET_UNIT_DEST_AREA_ENEMY);
            OnObjectAreaTargetSelect.Register(&spell_ds_earthen_vortex_teleport_SpellScript::FilterEffect2, EFFECT_2,
                                              TARGET_UNIT_DEST_AREA_ENEMY);
        }
    };
...
public:
    ...
    class spell_ds_black_blood_of_the_earth_periodic_AuraScript : public AuraScript
    {
        ...
        void Register()
        {
            OnEffectPeriodic.Register(&spell_ds_black_blood_of_the_earth_periodic_AuraScript::HandleTriggerSpell,
...
public:
    ...
    class spell_ds_black_blood_of_the_earth_damage_SpellScript : public SpellScript
    {
        ...
        void Register()
        {
            OnObjectAreaTargetSelect.Register(&spell_ds_black_blood_of_the_earth_damage_SpellScript::FilterTargets,
                                              EFFECT_0, TARGET_UNIT_DEST_AREA_ENEMY);
            OnObjectAreaTargetSelect.Register(&spell_ds_black_blood_of_the_earth_damage_SpellScript::FilterTargetsShared,
                                              EFFECT_1, TARGET_UNIT_DEST_AREA_ENEMY);
        }
    };
